...
import static com.example.project.GroupRequestController.smid;
...
public class memViewController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            String sregSql = "SELECT * FROM `sregistration` WHERE id='" + smid + "'";
            ...
            String sql = "SELECT * FROM `updatep` WHERE id='" + smid + "'";
